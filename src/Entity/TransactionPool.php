...
class TransactionPool extends AbstractEntity
{
    protected $fee; // 'fee' => 'text',
    protected $amount; // 'amount' => 'text',
    protected $amountWithFee; // 'amountWithFee' => 'text',
    protected $coinbase = false; // 'coinbase' => 'bool',
    protected $fromWalletId; // 'fromWalletId' => 'text',
    protected $bankHash; // 'bankHash' => 'text',
    protected $hash; // 'hash' => 'text type UNIQUE',
    protected $configHash; // 'configHash' => 'text',
    protected $toDo; // 'toDo' => '',
    protected $toDoHash; // 'toDoHash' => '',
    protected $url; // 'url' => 'text',
    protected $urlAction; // 'urlAction' => 'text',
    protected $transfers; // 'transfers' => 'text',
