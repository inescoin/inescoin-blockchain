...
class TransferPool extends AbstractEntity
{
     ...
     * @return mixed
     */
    public function getTranssactionHash()
    {
     ...
     * @return self
     */
    public function setTranssactionHash($transactionHash)
    {
